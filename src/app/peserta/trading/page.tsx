...
export default async function Page() {
  ...
  const stats = {
    usd: formatBigInt(tradingData.usd),
    idr: formatBigInt(tradingData.idr),
    eternites: formatBigInt(tradingData.eternites),
  ...
  return (
    <div className="overflow-hidden min-h-screen relative">
      ...
      <div className="absolute bg-gradient-to-b from-transparent via-[#AE00DE]/0 to-[#23328C] w-full h-full top-0 left-0"></div>
