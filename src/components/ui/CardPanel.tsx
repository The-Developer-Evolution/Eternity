...
export default function CardPanel({ 
  ...
  return (
    <section className={`relative z-10 p-12 box-border rounded-lg w-full max-h-160 overflow-y-auto overflow-x-hidden max-w-[80vw] bg-gradient-to-b from-[#79CCEE]/40 to-[#1400CC]/40 backdrop-blur-md shadow-lg border-[#684095] border-3 flex flex-col justify-start items-center gap-8 ${extraClass}`}>
