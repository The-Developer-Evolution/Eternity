...
async function main() {
  ...
  const participantUsers = [
    { name: "001_Trio Degem", password: "TrioDegem123" },
    { name: "002_YanSiTon", password: "3bapak" },
    { name: "003_Kwak Kwik Kwuk", password: "Kwekkwek" },
    { name: "004_KIRANA", password: "Leonxkirana" },
    { name: "005_Penggembira", password: "qwerty@123" },
    { name: "006_@ourlucky", password: "Ourlucky77." },
    { name: "007_Mi Luci", password: "MiLuci123" },
    { name: "008_BEBEK KAYANG", password: "rit" },
    { name: "009_cashback50ribu", password: "ekokolikheru" },
    { name: "010_Indomie", password: "sangargogo" },
    { name: "011_triokegelapanpart 2", password: "triopart2" },
    { name: "012_Alyntika", password: "Alyntika" },
    { name: "013_morgancorp", password: "morgancorporation" },
    { name: "014_Chasio", password: "Chasio" },
    { name: "015_RevenueRangers", password: "aditmadejoy" },
    { name: "016_Smart team", password: "Smartteamsukses" },
    { name: "017_capkakitigasiapmenang", password: "capkakitigagacor" },
    { name: "018_TRES", password: "tifrecelemmastress123" },
    { name: "019_alleyesonELCIDA", password: "Elcida_123" },
    { name: "020_eltimi", password: "eltimi123" },
    { name: "021_Wiwi", password: "Skibidiwiwi" },
    { name: "022_trizzierssehat", password: "trizziersjayajayajaya" },
    { name: "023_Pecel Juara", password: "peceljuara7k" },
    { name: "024_threeleches", password: "12345678" },
    { name: "025_GenAlpha", password: "papasisipaga88" },
    { name: "026_SMAZAONE", password: "12345678" },
    { name: "027_Trio_Limbus", password: "LimbusCompanyPeak" },
    { name: "028_SMAZA TWO", password: "qwertyuiop" },
    { name: "029_himmel", password: "petraoke" },
    { name: "030_bobok siang", password: "boboksiang123" },
    { name: "031_Cihuhuy", password: "Christian05" },
    { name: "032_anton", password: "4nt0n" },
    { name: "033_TERSERAH", password: "denyhandokoarip" },
    { name: "034_Hustle hive", password: "Tempetingtacos" },
    { name: "035_trio bagor", password: "triobagor123" },
    { name: "036_Elionix", password: "Elionix123" },
    { name: "037_Tjahaja Asia", password: "1sampai10" },
    { name: "038_Goblin Gang", password: "GoblinGang123" },
    { name: "039_Pejuang bitcoin", password: "iphschool" },
    { name: "040_Semoga Menang Amin", password: "SemogaMenangAmin123" },
    { name: "041_Pocky", password: "PockyAbc987" },
    { name: "042_EQUINOX", password: "EQUINOXWILLWIN#8965" },
    { name: "043_Bikini Bottom", password: "Bejengre123" },
    { name: "044_HapHoo", password: "nalajosjis" },
    { name: "045_NalaImpatc", password: "Nalaisme2026" },
    { name: "046_Circlefarminitiative", password: "Jadijuara1" },
    { name: "047_Husky", password: "Libels123" },
    { name: "048_ATHENA", password: "athena123" },
    { name: "049_GOAT TEAM", password: "GOATTEAM123" },
    { name: "050_LombaSabtuMinggu", password: "CarelGeorgeSteven" },
    { name: "051_CELITA", password: "14042008" },
    { name: "052_the blue", password: "theblue123" },
    { name: "053_SABUN LIFEBUOY", password: "SABUNLIFEBUOY123" },
    { name: "054_gacorr", password: "gacorr123" },
    { name: "055_PBBJB", password: "PBBJB2728" },
    { name: "056_TIM Gwachor", password: "TIMGwachor123" },
    { name: "057_Uganda Forever", password: "UgandaForever123" },
    { name: "058_eternityx", password: "sepuluhtahun" },
    { name: "@ourlucky", password: "Ourlucky77." },
    { name: "Chasio", password: "Chasio" },
    { name: "LombaSabtuMinggu", password: "CarelGeorgeSteven" },
    ...
    { name: "Tjahaja Asia", password: "1sampai10" },
    ...
    { name: "NalaImpatc", password: "Nalaisme2026" },
    { name: "NalaImpact", password: "Nalaisme2026" },
